...
document.querySelector("#make-rect").addEventListener("click", function(event){
    ...
    dragDiv.setAttribute("style", "height:" + (parseInt(document.querySelector("#rect-height").value) + 10) + "px; width:" + (parseInt(document.querySelector("#rect-width").value) + 10) + "px");
    ...
    let newCanvas = document.createElement("canvas");
    newCanvas.classList.add("canvas-child");
